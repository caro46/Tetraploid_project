...
Some people seem to have issue with step. For example [see](https://www.biostars.org/p/212727/). Maybe try Racon as suggested on the biostars issue. Or we might just want to use bwa and just call the consensus if it keeps taking forever... 
