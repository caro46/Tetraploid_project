...
1/06: failure of the run using pacbio reads >3kb + chimeras. Same error message `ExitCode 139` from Slurm (`128 + 11` (for segfault)) and `Segmentation fault (core dumped)`. 
