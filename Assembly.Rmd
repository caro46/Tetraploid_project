...
/work/ben/2016_Hymenochirus/SOAPdenovo2-src-r240/SOAPdenovo-125mer all -s Mellotropicalis_all_libraries.conf -K 67 -R -N 3500000000 -V -p 10 -o SOAP_Mellotropicalis_BJE3652_genome_all_libraries_67
```
**Note 09/08:** 
...
- Should use `velvet` and merge multiple assemblies obtained with different kmer size (65 & 67 at least) to compare the result. [Allpaths](ftp://ftp.broadinstitute.org/pub/crd/ALLPATHS/Release-LG/AllPaths-LG_Manual.pdf) seems to be a good alternative option too for our dataset (but not for *Hymenochirus*):
