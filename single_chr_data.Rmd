...
Goal1: Checking how much of the different libraries match against *X. tropicalis* genome. See [bwa.pl](https://github.com/caro46/Tetraploid_project/blob/master/some_scripts/bwa.pl) submitted like that: `sbatch ~/project/cauretc/scripts/running_bwa.sh`.
