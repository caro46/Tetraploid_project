...
```
Seemed to cause issue for later. Same issue as specified [here](https://github.com/isovic/racon/issues/24). Trying:
```
...
### racon - run 1
```
/home/cauretc/project/cauretc/programs/minimap2/minimap2 Only_pacbio_mellotrop_miniasm_raw_assembly1.fa /home/cauretc/scratch/pacbio_mellotrop/raw_bam/BJE3652.all.subreads.nolengthlimit.q30.fastq.gz > Only_pacbio_mellotrop.miniasm_raw_assembly1.reads_mapped.paf

/home/cauretc/project/cauretc/programs/racon/bin/racon -t 3 --bq -1 /home/cauretc/scratch/pacbio_mellotrop/raw_bam/BJE3652.all.subreads.nolengthlimit.q30.fastq.gz Only_pacbio_mellotrop.miniasm_raw_assembly1.reads_mapped.paf Only_pacbio_mellotrop_miniasm_raw_assembly1.fasta Only_pacbio_mellotrop.racon1.fasta
```
### racon - run 2
```
