...
We are using `allpaths-LG` for assembling Illumina reads that seems to give the best result today. Other examples of hybrid and non-hybrid strategies [here](https://github.com/PacificBiosciences/Bioinformatics-Training/wiki/Large-Genome-Assembly-with-PacBio-Long-Reads). 
