...
```
By specifying `MAX_MEM_GB=500` when re-running (no overwrite): new files (that previously failed) were created (ex. `6kb_2_2.fastb`). Run on Iqaluk (before Wobbie) for the last files `6kb_10` to `6kb_19` without memory restriction.
