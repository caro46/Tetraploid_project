...
[GMcloser](https://academic.oup.com/bioinformatics/article/31/23/3733/209212) says it is more accurate however uses more memory and longer time than `GapCloser`... More memory seem a lot... So better seems to try to run correctly `GapCloser` then `bwa` and consensus.
